...
public class InstructorApi {
    ...
    public String assignInstructorToCourse(@RequestParam Long courseId, @RequestParam Long instructorId) {
        instructorService.assignInstructorToCourse(courseId, instructorId);
        return "redirect:/courses/{courseId}/getInstructorsByCourseId";
    }
